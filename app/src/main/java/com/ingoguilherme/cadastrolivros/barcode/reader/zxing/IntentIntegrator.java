package com.ingoguilherme.cadastrolivros.barcode.reader.zxing;/*
...
import com.ingoguilherme.cadastrolivros.BarcodeFragment;
...
public class IntentIntegrator {
    ...
    protected Class<?> getDefaultCaptureActivity() {
        return CaptureActivityAnyOrientation.class;
    }
    /**
    ...
    public static IntentIntegrator forFragment(BarcodeFragment fragment) {
        IntentIntegrator integrator = new IntentIntegrator(fragment.getActivity());
